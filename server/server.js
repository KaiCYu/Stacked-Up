...
//                     let queryApplicantId = `SELECT id FROM applicants WHERE username="${req.body.username}"`;
//                     let insertApplicantInfo = `INSERT INTO applicants SET ?`;
...
//                       state: req.body.state,
//                       country: req.body.country,
//                       resume_url: resume.secure_url,
//                       coverletter_url: coverLetter.secure_url,
//                       profile_pic_url: image.secure_url,
//                     }

//                     let insertUrlToApplicantFile = `INSERT INTO applicant_files (url, type, applicant_id) 
//                    `;

//                     db.queryAsyncQuestion(insertApplicantInfo, values)
//                       .then((result) => {
//                         res.json(result);
//                         // index elasticsearch with new applicant
//                         elasticsearch.indexDatabase();
